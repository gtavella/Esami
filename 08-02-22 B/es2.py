...
def verifica_lista(L,k):
    ...
    for i in range(k, len(L)):
        ...
        print(stringa_campione, stringhe_target)
        ...
        for stringa_target in stringhe_target:
            # inizializzo ad ogni nuova stringa target
            ...
            while not esiste_lettera and j<len(stringa_campione):
                # ogni lettera della stringa attuale
                ...
                if l in stringa_target:
                    # esco dal loop perche' ho trovato almeno una lettera in comune in ogni altra stringa
                    esiste_lettera = True
                j += 1
            ...
            # se non c'era nessuna lettera in comune, allora esci
